<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="Compose.aspx.cs" Inherits="_Default" %>
      ...
      <div class="col-12 col-md-7 col-lg-6 col-xl-5 d-flex align-items-start flex-column px-vw-5">
        ...
        <header class="mb-auto py-vh-2 col-12">
          <a class="navbar-brand pe-md-4 fs-4 col-12 col-md-auto text-center " href="Compose.aspx">
            ...
            <span class="ms-md-1 mt-1 fw-bolder me-md-5 text-decoration-underline">Compose</span>
          </a>
          <a class="navbar-brand pe-md-4 fs-4 col-12 col-md-auto text-center" href="Recived.aspx">
            ...
            <span class="ms-md-1 mt-1 fw-bolder me-md-5">Recived</span>
          </a>
            ...
            <div class="col-12">
              ...
              <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Email</label>
                  <asp:TextBox ID="TextBox3" runat="server" class="form-control form-control-lg bg-gray-800 border-dark textAreaHeight" TextMode="MultiLine"></asp:TextBox>
              </div>
                <asp:Button ID="Button1" runat="server" Text="Send"  class="btn btn-white btn-xl mb-4" OnClick="Button1_Click"></asp:Button>
            </div>
