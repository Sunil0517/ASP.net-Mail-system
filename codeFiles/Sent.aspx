<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="Sent.aspx.cs" Inherits="_Default" %>
    ...
    <div class="container">
        <header class="mb-auto py-vh-2 col-12">
          ...
          <a class="navbar-brand pe-md-4 fs-4 col-12 col-md-auto text-center " href="Sent.aspx">
            ...
            <span class="ms-md-1 mt-1 fw-bolder me-md-5 text-decoration-underline">Sent</span>
          </a>  
      ...
      <div class="row d-flex justify-content-center  pb-0">
          ...
          <div class="row d-flex align-items-start" data-aos="fade-right">
            ...
            <div class="col-12 col-lg-4 offset-lg-1  p-5 mt-5">
              <h3 class="h6">To</h3>
                <!-- <asp:Label ID="Label3" runat="server" Text='<%# Eval("emailTo") %>' class="text-secondary"></asp:Label>-->
               <!--  <asp:Label ID="Label4" runat="server" Text='<%# Eval("dateTime") %>'></asp:Label>-->
              <p class="text-secondary"><%# Eval("emailTo") %></p>
